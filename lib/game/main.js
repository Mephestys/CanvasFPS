...
const MyGame = tpf.Game.extend({
	...
	setupDesktopControls: function() {
		...
		ig.input.bind( ig.GAMEPAD.LEFT_SHOULDER_BOTTOM, 'shoot2' );
	...
	spawnPowerup: function() {
		// 1/3 chance for health, 1/3 chance for plasma, 1/3 chance for grenades
		const powerups = [EntityHealthPickup, EntityPlasmaPickup, EntityGrenadePickup];
		const entityClass = powerups.random();
