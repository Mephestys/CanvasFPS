	...
	switchWeapon: function( index ) {
		...
		if (this.currentWeapon.ammoIcon && !this.currentWeapon.secondaryAmmoIcon) {
			this.currentWeapon.ammoIcon.setPosition( 
				128, 
				ig.game.hud.height-this.currentWeapon.ammoIcon.tileHeight - 3
			);
		}
		...
		if (this.currentWeapon.ammoIcon && this.currentWeapon.secondaryAmmoIcon) {
			this.currentWeapon.ammoIcon.setPosition( 
				128, 
				ig.game.hud.height-this.currentWeapon.ammoIcon.tileHeight - 12
			);
			this.currentWeapon.secondaryAmmoIcon.setPosition(
				128,
				ig.game.hud.height - this.currentWeapon.secondaryAmmoIcon.tileHeight - 3
			);
		}
